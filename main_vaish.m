...
for i = 1:n
    ...
    % figure; 
    % stem((50:250), symbols_vector(50:250));
    ...
    figure;
    plot((200:400), line_vector_rect(200:400), 'LineWidth', 1.5);
    title("Line coding with rectangular function")
    xlabel("time")
    ylabel("amplitudes")
    ylim([0 4])

    n = length(line_vector_rect);
    X = fft(line_vector_rect); 
    % f = (0:n-1)*(fs*0.5/n);
    ...
    final_output_rcos = fourpamunmapA(decoded_downsample_rcos,1);
